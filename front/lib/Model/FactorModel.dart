...
class FactorModel {
  ...
  FactorModel(this.stdTaskCd, this.riskCate1Name, this.riskCate2Name,
      this.riskFactor, this.riskRelatedLaw);

  factory FactorModel.fromJson(Map<String, dynamic> json){
    return FactorModel(json["stdTaskCd"], json["riskCate1Name"], json["riskCate2Name"], json["riskFactor"], json["riskRelatedLaw"]);
  }
